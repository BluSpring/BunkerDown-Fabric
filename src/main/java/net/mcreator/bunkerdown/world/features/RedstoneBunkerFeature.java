...
public class RedstoneBunkerFeature
extends Feature<NoneFeatureConfiguration> {
    public static RedstoneBunkerFeature FEATURE = null;
    ...
    public static Feature<?> feature() {
        FEATURE = new RedstoneBunkerFeature();
        CONFIGURED_FEATURE = FeatureUtils.register((String)"bunker_down:redstone_bunker", (Feature)FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register((String)"bunker_down:redstone_bunker", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }

    public RedstoneBunkerFeature() {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (this.template == null) {
            this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("bunker_down", "redstonebunker4_rundown"));
        }
        if (this.template == null) {
            return false;
        }
        ...
        if (context.random().nextInt(1000000) + 1 <= 5000) {
            ...
            for (int a = 0; a < count; ++a) {
                ...
                BlockPos spawnTo = new BlockPos(i + 0, j + -30, k + 4);
