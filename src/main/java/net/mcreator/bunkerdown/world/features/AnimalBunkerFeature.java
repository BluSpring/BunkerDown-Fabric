...
public class AnimalBunkerFeature
extends Feature<NoneFeatureConfiguration> {
    public static AnimalBunkerFeature FEATURE = null;
    ...
    public static Feature<?> feature() {
        FEATURE = new AnimalBunkerFeature();
        CONFIGURED_FEATURE = FeatureUtils.register((String)"bunker_down:animal_bunker", (Feature)FEATURE, (FeatureConfiguration)FeatureConfiguration.NONE);
        PLACED_FEATURE = PlacementUtils.register((String)"bunker_down:animal_bunker", CONFIGURED_FEATURE, List.of());
        return FEATURE;
    }

    public AnimalBunkerFeature() {
    ...
    public boolean place(FeaturePlaceContext<NoneFeatureConfiguration> context) {
        ...
        if (this.template == null) {
            this.template = context.level().getLevel().getStructureManager().getOrCreate(new ResourceLocation("bunker_down", "animalbunker2"));
        }
        if (this.template == null) {
            return false;
        }
